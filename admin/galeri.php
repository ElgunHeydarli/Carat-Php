...
while ($galericek=$galerisor->fetch(PDO::FETCH_ASSOC)) { ?>
                    ...
                    <tr>
                      <td><img style="width:150px" src="resimler/galeri/<?php echo $galericek['galeri_resim'] ?>"></td>
                       <td><?php echo $galericek['galeri_kat'] ?></td>
                      <td><?php echo $galericek['galeri_baslik'] ?></td>
                     
                        <td><?php echo $galericek['galeri_sira'] ?></td>
                          
                    <td><a href="duzenle.php?sayfa=galeri&id=<?php echo $galericek['galeri_id'] ?>"><button type="submit" class="btn btn-success">Düzəliş</button></td>
                         <td>
 ...
 <td><a href="cokluresim?id=<?php echo $galericek['galeri_id'] ?>"><button class="btn btn-success">Çoxlu şəkil</button></a></td>
