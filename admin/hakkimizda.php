...
<?php } elseif (@$_GET['durum']=="no") { ?>
  <p style="color:red ; ">Uğursuz nəticə</p>

<?php }  ?>
              <div class="card-header">
                <h3 class="card-title">Haqqımızda</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="islem.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-footer">
                  <button name="hakkimizdakaydet" style="float:right" type="submit" class="btn btn-primary">Yadda saxla</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
